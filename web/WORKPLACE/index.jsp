    ...
    <head>
        <meta charset="utf-8">
            ...
            <style>                
                ...
                /*@import url('css/recollections-of-wartime.css');*/               
        ...
        <!--Import bootstrap css END-->    
            ...
            <link href="../css/ebook_pageoverview.css" rel="stylesheet" type="text/css">
                
            <link href="css/recollections-of-wartime.css" rel="stylesheet" type="text/css" />
            ...
            <div class="row">   
                ...
                <div class="col-md-10">
                    <div class="row">                                           
                        ...
                        <div id="zbookMenuContainer" class="col-md-9" style="height: 200px; background: #00ffff;">
                            ...
                            <div id="pageOperations"> 
                                ...
                                <div id="addTextBox" class="operationDiv"><img src="http://www.educationshanghai.com/images/Document_Writing_Img.jpg" class="img-circle"></div>                                                 
                                <div id="addImageBox" class="operationDiv"><img src="https://img0.etsystatic.com/037/0/8035680/il_340x270.514455184_lr2i.jpg" class="img-circle"></div>                        
                                <div id="addVideoBox" class="operationDiv"><img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQrzoONavz-OglDtoU6J1_qnVhdovKsk-0oQL0c_oYD0niNZ0AkGAzyp5mJ" class="img-circle"></div>
                                <div id="addFigureBox" class="operationDiv"><img src="add figure" class="img-circle"></div>
                                <div id="addDrawBox" class="operationDiv"><img src="http://thecreativehome.yolasite.com/resources/paint-wall-lg.jpg" class="img-circle"></div>
                    ...
                    <div class="row" > 
                        ...
                        <div class="col-md-3">
                            <div id="zbookPagesContainer" >    
                                
                            <!--Her overview ici olmasi gereken özellik-->
                                <div class="pageOverviewContainer">
                                    
                                    <div class="pageOverview_addPage" addType="prev"></div>
                                    
                                    <div class="draggableIframeDIV pageOverview" pagenum="1" pagetype="origin">                                       
                                        <section class="xxx" pagenum="1" style="height: 100%; width: 100%; overflow: auto; background: rgb(238, 238, 238);"></section>                 
                                    </div>                                                                                                               
                                    
                                </div>                                                            

                                <div class="pageOverview_addPage" addType="next"> </div>
                                                                                                                                        
                                   
                                
                            <!--IFrame Import Workplace

                                <div class="draggableIframeDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"><iframe style="height: 100% !important; width: 100% !important;" src="../epubTemp/OPS/s001-Other-01.xhtml"></iframe></div>
                                <div class="draggableIframeDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"><iframe style="height: 100% !important; width: 100% !important;" src="../epubTemp/OPS/s002-Frontispiece-01.xhtml"></iframe></div>
                                <div class="draggableIframeDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"><iframe style="height: 100% !important; width: 100% !important;" src="../epubTemp/OPS/s003-BookTitlePage-01.xhtml"></iframe></div>               
                                <div class="draggableIframeDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"><iframe style="height: 100% !important; width: 100% !important;" src="../epubTemp/OPS/s004-Copyright-01.xhtml"></iframe></div>
                                <div class="draggableIframeDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"><iframe style="height: 100% !important; width: 100% !important;" src="../epubTemp/OPS/s005-Dedication-01.xhtml"></iframe></div>
                                <div id="myEditableDiv" class="draggableMainDIV" style="padding: 15px; margin: 15px; background: salmon; width: 400px; height: 200px; overflow: auto; float: left;"></div>
                                <button id="uplader">Load page</button>
                        ...
                        <div id="zbookPageContainer" class="col-md-9 edittablePagex" style="height: 600px; background: #EEE; z-index: 0;">

                            
                            
                            <section class="present" pagenum="1" style="height: 100%; width: 100%; overflow: auto; background: rgb(238, 238, 238);"></section>
